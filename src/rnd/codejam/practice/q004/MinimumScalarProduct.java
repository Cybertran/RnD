package rnd.codejam.practice.q004;
 ...
 * Input
 * 
 * The first line of the input file contains integer number T - the number of
 * test cases. For each test case, the first line contains integer number n. The
 * next two lines contain n integers each, giving the coordinates of v1 and v2
 * respectively.
 * 
 * Output
 * 
